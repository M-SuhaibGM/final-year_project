        ...
        <div className="flex flex-col items-center justify-center p-10 bg-blue-200 border-2 border-dashed rounded-3xl shadow-sm">
            ...
            {!isTesting ? (
                <button
                    ...
                    className="bg-primary text-white cursor-pointer  px-8 py-3 rounded-full font-bold hover:bg-blue-700 transition-all shadow-lg"
                >
                    Test Microphone
                </button>
            ) : (
                <button
                    onClick={onMicReady}
                    className="bg-green-600 text-white px-8 py-3 cursor-pointer rounded-full font-bold hover:bg-green-700 transition-all shadow-lg flex items-center gap-2"
                >
